...
async function initChatPage() {
  ...
  try {
    ...
    user = { email: claims.email || claims['cognito:username'] || 'You', display_name: null };
  }
  ...
  // Modal save/cancel
  document.getElementById('display-name-save').addEventListener('click', saveDisplayName);
